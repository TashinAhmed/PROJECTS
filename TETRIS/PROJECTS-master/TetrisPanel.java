...
public class TetrisPanel extends JPanel implements KeyListener, ActionListener{
    ...
    public TetrisPanel() throws InterruptedException{

        con = new TetrisControl();
        shape1 = new TetrisShape1();
        shape2 = new TetrisShape2();
        shape3 = new TetrisShape3();
        shape4 = new TetrisShape4();
        shape5 = new TetrisShape5();
        spin=0;
        ...
        if(num==1){
            ...
            if(reached==true){
                ...
                if(shape1.onSide==false){
                    con.cont[yNum-2][xNum]=TetrisControl.colr;
                    con.cont[yNum-1][xNum]=TetrisControl.colr;
                    con.cont[yNum][xNum]=TetrisControl.colr;
                }

                if(shape1.onSide==true){
                    con.cont[yNum][xNum-2]=TetrisControl.colr;
                    con.cont[yNum][xNum-1]=TetrisControl.colr;
                    con.cont[yNum][xNum]=TetrisControl.colr;
                }
        ...
        if(num==2){
            ...
            if(reached==true){                                 //this draws the shape where it lands on the panel and sets the array.
                if(shape2.onSide==1){
                    ...
                    con.cont[yNum+1][xNum]=TetrisControl.colr;
                    con.cont[yNum+2][xNum]=TetrisControl.colr;
                    con.cont[yNum+1][xNum+1]=TetrisControl.colr;
                }
                //this draws the shape where it lands on the panel and sets the array.
                if(shape2.onSide==2){
                    con.cont[yNum+1][xNum-1]=TetrisControl.colr;
                    con.cont[yNum+1][xNum]=TetrisControl.colr;
                    con.cont[yNum+1][xNum-2]=TetrisControl.colr;
                    con.cont[yNum][xNum-1]=TetrisControl.colr;
                }
                //this draws the shape where it lands on the panel and sets the array.
                if(shape2.onSide==3){
                ...
                if(shape2.onSide==4){
                    con.cont[yNum-2][xNum]=TetrisControl.colr;
                    con.cont[yNum-1][xNum]=TetrisControl.colr;   //on its back pointing up
                    con.cont[yNum][xNum]=TetrisControl.colr;
                    con.cont[yNum-1][xNum-1]=TetrisControl.colr;
                }
            }
